            ...
            try
            {
                ...
                switch (type)
                {
                    case "CA":
                        try
                        {
                            await botClient.EditMessageTextAsync( //Отправляем сообщение с информацией о сайтах Канады
...
",
            ...
            {
                await botClient.SendTextMessageAsync( //Отправляем сообщение с информацией о сайтах Канады
                 chatId: update.CallbackQuery.From.Id,
