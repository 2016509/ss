...
namespace servicematters_pdf_checker.Methods
{
    class CustomHttpClass
    {
        ...
        /// <returns></returns>
        public static string GetToString(string url, List<CustomHttpAdditionals.Headers> headers = null, string referrer = null, string acceptencoding = null, bool use_google_ua = true, CookieStorage coockies = null, bool use_chrome_random_ua = false, DatabaseProxyData selected_proxy = null)
        {
        ...
        public static string GenerateUserAgent()
        {
            ...
            return @$"Mozilla/5.0 ({os[int.Parse(Math.Round(rnd.NextDouble() * os.Length).ToString())]}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{Math.Round(rnd.NextDouble() * 4) + 100}.0.{Math.Round(rnd.NextDouble() * 190) + 4100}.{Math.Round(rnd.NextDouble() * 50) + 140} Safari/537.36";
